...
public class FileParserTest {
    ...
    void testSuccessfulRead() {
        FileParser fileParser = new FileParser(Paths.get("src/test/resources/project3Test/testLog.log"));
        List<LogReport> logs = fileParser.parseLogs();

        assertThat(logs.size()).isEqualTo(2);
        assertThat(logs).containsExactlyInAnyOrderElementsOf(
            List.of(
                new LogReport(
                    "5.9.121.211",
    ...
    void testFailedReadLineInFile() {
        FileParser fileParser = new FileParser(Paths.get("src/test/resources/project3Test/badLog.log"));
    ...
    void testLoadLargeLog(){
        FileParser fileParser = new FileParser(Paths.get("src/test/resources/project3Test/largeLog.log"));
        List<LogReport> logs = fileParser.parseLogs();
